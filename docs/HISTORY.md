# Historique de développement — TERMINAL Finance Career Simulator

Chronologie narrative des refontes et lots de contenu, déplacée depuis
CLAUDE.md (qui ne garde que les conventions et invariants ACTIFS).
Chaque section documente le POURQUOI des décisions — à consulter avant de
revenir sur un choix d'architecture.
