"""
tests/test_scene_explorer.py — Vérifications de l'explorateur de marché,
notamment l'animation live des cours.
"""
import os
...
def test_explorer_draw_with_live_flash(app):
    scene = MarketExplorerScene(app)
    scene.on_enter(return_to="terminal")
    scene.update(0.016)
