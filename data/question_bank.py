...
QUESTIONS = [
    ...
    {"grade": 2, "track": "Portfolio", "diff": 4,
    ...
    {"grade": 2, "track": "Portfolio", "diff": 3,
    ...
    {"grade": 3, "track": "Portfolio", "diff": 4,
    ...
    {"grade": 4, "track": "Portfolio", "diff": 5,
    ...
    {"grade": 5, "track": "Portfolio", "diff": 5,
...
def available_pool(grade_index, track="General"):
...
def for_grade(grade_index, track="General", count=5, rng=None):
    """
    ...
    """
    rng = rng or random
    pool = available_pool(grade_index, track)
    if not pool:
        return []
