...
EVENT_TEMPLATES = [
    # ----------------------------- favorables -----------------------------
    {"id": "bull_run", "title": "Rallye haussier sur les indices",
    ...
    {"id": "good_call", "title": "Votre note d'analyse fait mouche",
    ...
    {"id": "mandate_won", "title": "Mandat remporté face à un concurrent",
    ...
    {"id": "carry_paid", "title": "Versement de carried interest",
    ...
    # ---------------------------- défavorables ----------------------------
    {"id": "selloff", "title": "Correction brutale des marchés",
     "desc": "Un choc de volatilité fait dévisser les actifs risqués.",
     "kind": "bad", "cash": (-90_000, -25_000), "rep": (-2, 0),
     "weight": 8, "regions": None, "min_grade": 0, "cash_scale": True},

    {"id": "fat_finger", "title": "Erreur de saisie sur un ordre",
    ...
    {"id": "margin_call", "title": "Appel de marge inattendu",
    ...
    {"id": "fine", "title": "Sanction du régulateur",
    ...
    {"id": "ecb_surprise", "title": "Décision surprise de la BCE",
    ...
    {"id": "fed_pivot", "title": "Pivot de la Fed",
    ...
    {"id": "hkd_peg", "title": "Pression sur le peg du HKD",
    ...
    # ------------------------------ neutres -------------------------------
    {"id": "quiet", "title": "Séance sans tendance",
    ...
    {"id": "networking", "title": "Conférence sectorielle",
