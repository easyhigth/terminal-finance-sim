...
class EvaluationScene(Scene):
    ...
    def _finish(self):
        # toute la logique (marquage des questions, promotion / certif,
        # déblocages, inbox, sauvegarde) vit dans core/exam_flow — partagée avec
        # l'app native ; ici on ne fait que jouer les toasts et passer au récap.
        from core import exam_flow
